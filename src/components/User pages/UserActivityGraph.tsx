    ...
    <Box display={{ xs: 'block', md: 'flex' }} justifyContent="space-between" p={2} width={"100%"}>
      ...
      <Box flex={1} mr={{ md: 1 }} sx={{backgroundColor: "#f0f0f045", padding: 2, borderRadius: 2}}>
        <Box display="flex" alignItems="center" justifyContent="center" mb={1}>
          <IconButton onClick={handlePreviousMonth}><ArrowBackIos /></IconButton>
          <Typography variant="h6" sx={{color: "#3ec1c1"}}>
        ...
        <ResponsiveContainer width={"100%"} height={300}>
          <BarChart data={monthlyData}>
            ...
            <Tooltip />
            <Legend />
            <Bar dataKey="visits" fill="#3ec1c1" />
          </BarChart>
        </ResponsiveContainer>
      </Box>
      ...
      <Box flex={1} ml={{ md: 1 }} sx={{backgroundColor: "#f0f0f045", padding: 2, borderRadius: 2}}>
        <Box display="flex" alignItems="center" justifyContent="center" mb={1}>
          <IconButton onClick={handlePreviousYear}><ArrowBackIos /></IconButton>
          <Typography variant="h6" sx={{color: "#e14a4acf"}}>
        ...
        <ResponsiveContainer width={"100%"} height={300}>
          <LineChart data={yearlyData}>
            ...
            <Tooltip />
            <Legend />
            <Line type="monotone" dataKey="visits" stroke="#e14a4acf" strokeWidth={2} />
          </LineChart>
        </ResponsiveContainer>
      </Box>
    </Box>
